...
export const DriftAlertConfigModal: React.FC<DriftAlertConfigModalProps> = ({
  ...
  const [customUnit, setCustomUnit] = useState<'-Ás' | 'ms' | 's'>('-Ás');
  ...
  // Convert linear slider 0-100 to log scale 1 -Ás to 40,000,000 -Ás
      ...
      >
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-cyan-500/20 text-cyan-300 border border-cyan-400/30 flex items-center gap-1">
                  ...
                  Live BIPM Drift: +{CURRENT_TAI_UTC_OFFSET}s (+37,000,000 -Ás)
                </span>
              </div>
                ...
                <div className="pt-3 border-t border-slate-800 space-y-3">
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-2 flex-1">
                      ...
                      >
                        <option value="-Ás">-Ás (Microseconds)</option>
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold ${
                        ...
                        {isCurrentlyBreached ? `BREACHED (${exceedanceRatio}+ù)` : 'WITHIN SAFETY BOUND'}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-400 mt-0.5">
                      Current TAI-UTC divergence is <strong className="text-cyan-300 font-mono">+{CURRENT_TAI_UTC_OFFSET}.000s</strong> (+37,000,000 -Ás).
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-4 animate-fadeIn">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Active monitoring rules stored securely for <span className="text-amber-300 font-mono">{email || defaultEmail}</span>.
                  </p>
                </div>
              ...
              {isLoadingRules ? (
                <div className="p-8 text-center text-slate-400 space-y-2">
                  ...
                  <p className="text-xs">Loading monitoring rules…</p>
                </div>
              ) : savedRules.length === 0 ? (
                          ...
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              ...
                              <span className="text-[11px] text-slate-400 font-mono">
                                Target: {rule.email} ÔÇó {rule.system_context}
                              </span>
                            </div>
                          </div>
        ...
        <div className="p-4 bg-slate-950 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2 text-slate-400 text-[11px]">
            ...
            <span>Encrypted Edge Dispatch ÔÇó BIPM-TAI Monitored ÔÇó Zero Spam Guarantee</span>
          </div>
