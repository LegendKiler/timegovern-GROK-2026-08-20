...
export const LEAP_SECOND_FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    authority: 'Bureau International des Poids et Mesures (BIPM), Sèvres, France',
    updatedDate: 'August 2026',
    detailedAnswer: (
      <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
        <p>
          Unlike a physical master clock sitting in a room, <strong>UTC is a computed paper time scale</strong> generated retrospectively each month by the <strong>BIPM Time Department</strong> in Sèvres, France.
        </p>
  ...
  },
  {
    ...
    question: 'What is NTP Leap Smearing and why do Google, Meta, and Cloudflare use it?',
    ...
    tags: ['Leap Smear', 'POSIX', 'Cloudflare', 'Google', 'Meta', 'HFT'],
      ...
      <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
        ...
        <div className="bg-slate-100 dark:bg-slate-950 p-3 rounded-xl border border-slate-200 dark:border-slate-800 space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
            ...
            <div className="border border-slate-200 dark:border-slate-800 p-2 rounded-lg bg-white dark:bg-slate-900">
              <span className="font-bold text-blue-600 dark:text-blue-400">Meta & Cloudflare 17h/12h Slew</span>
