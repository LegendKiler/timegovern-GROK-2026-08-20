  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="border-b border-slate-200 dark:border-slate-800/80 bg-slate-100/90 dark:bg-slate-950/40">
        <div className="max-w-[1600px] mx-auto px-3 sm:px-4 py-1.5 flex items-center justify-between gap-2 text-[11px] text-slate-600 dark:text-slate-400">
      ...
      {showAds && !isSupporter && (
        <div className="w-full max-w-[1600px] mx-auto px-3 sm:px-4 pt-2">
          <AdBanner type="leaderboard" />
        </div>
      )}

      <main className="flex-1 max-w-[1600px] w-full mx-auto px-3 sm:px-4 py-4 flex flex-row gap-4 items-start">
